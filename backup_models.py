...
class CourseReviewSummaries(models.Model):
    ...
    dist_json = models.JSONField()
    updated_at = models.DateTimeField()
    review_sum = models.TextField(blank=True, null=True, db_comment='사용자 리뷰 요약')
...
class CourseSumm(models.Model):
    ...
    group_activity = models.CharField(max_length=1)
...
class SavedTimetable(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'saved_timetable'


class SavedTimetableCourses(models.Model):
    timetable = models.ForeignKey('SavedTimetables', models.DO_NOTHING)
    course_id = models.IntegerField(blank=True, null=True)
    course_name = models.CharField(max_length=255)
...
class SavedTimetableSchedules(models.Model):
    timetable_course = models.ForeignKey(SavedTimetableCourses, models.DO_NOTHING)
...
class SavedTimetables(models.Model):
    user_id = models.IntegerField()
...
class UserReview(models.Model):
    ...
    summary = models.ForeignKey(CourseReviewSummaries, models.DO_NOTHING)
